import { MeleeWeapon } from '@/src/schemas/data-sheet.schema';
import { Fragment } from 'react/jsx-runtime';

export interface MeleeWeaponsContentProps {
  weapons: MeleeWeapon[];
}

export default function MeleeWeaponsContent({ weapons }: MeleeWeaponsContentProps) {
  return (
